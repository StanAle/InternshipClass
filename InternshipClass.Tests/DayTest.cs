...
namespace InternshipClass.Tests
{
    public class DayTest
    {
        ...
        public void ConvertOutputOfWeatherAPIToWeatherForecast()
        {
            ...
            var weatherForecastController = new WeatherForecastController(nullLogger,null);
